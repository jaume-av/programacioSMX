...
### Tasca #3: Modifica la Tasca #2 per:

1. Que el jugador haja de agafar els projectils.
2. Quan el jugador agafe un projectil, que la puntuació augmente en 2 punts.
3. Que el jugador perda 1 punt quan un projectil es perda (siga destruït automàticament en sortir de la pantalla).
4. Fes que el joc acabe quan la puntuació siga negativa.