...
L’operador **+** també pot utilitzar-se amb **cadenes de text**.
En este cas, no suma, sinó que **ajunta** (concatena) els textos:
...
Els operadors **no s’avaluen d’esquerra a dreta sempre**.
Python segueix un **ordre de prioritat** (precedència), igual que en matemàtiques.
...
- `not False` → `True`, després `True and True`.

---

### **Regla d’or **

> **Si tens dubtes, usa parèntesis.**
> Fan el codi més clar i eviten errors.
