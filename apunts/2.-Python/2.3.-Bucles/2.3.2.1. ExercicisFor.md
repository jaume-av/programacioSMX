...
# Cas pràctic 2 — Control d’accessos amb intents limitats (for)

## Enunciat

Volem crear un programa que simule un **control d’accés**.

El programa ha de funcionar de la manera següent:

* L’usuari té **3 intents com a màxim** per a escriure la contrasenya correcta.
* La contrasenya correcta és **"python123"**.
* Si l’usuari l’encerta dins dels intents disponibles:

  * Es mostrarà el missatge **“Accés concedit”**
  * El programa acabarà.
* Si l’usuari falla els 3 intents:

  * Es mostrarà el missatge **“Accés bloquejat”**

Cal utilitzar:

* Un **bucle `for`**
* Una estructura `if`
* L’ordre `break` quan siga necessari
